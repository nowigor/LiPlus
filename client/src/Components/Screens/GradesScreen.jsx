...
const GradesScreen = () =>{
    ...
    const tmp_data = [
        { id: "1", name: "Język Polski", grades: ["1", '2', '5+', '2+', '1'], absence: 50, average: 4.45 },
        ...
        { id: "12", name: "Muzyka", grades: ["5", '5+', '5', '5+', '5+'], absence: 8, average: 4.95 },
        ...
        { id: "20", name: "Prawo", grades: ["2", '3', '2+', '3', '2+'], absence: 24, average: 2.75 },
    ];
